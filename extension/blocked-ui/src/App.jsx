    ...
    function buildRecommendations(company, reports) {
            ...
            async function loadCompany() {
                ...
                try {
                    ...
                    const reportsResponse = await fetch(
                        `${API_BASE}/reports?company_id=${data.id}&limit=10&offset=0`
                    );
                    
                    let reportsData = [];

                    if (!reportsResponse.ok) {
                        throw new Error(`Back-end returned ${reportsResponse.status}.`);
                    }
            ...
            <div className="page">
                <div className="card">
                    ...
                    */}
                    ...
                    {/*
                        Recommendations on how to stay safe while browsing the internet.
                    */}
                    <div className="section">
